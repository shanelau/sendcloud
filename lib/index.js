...
function getListMemberData(mail_list_addr, member_addr, name, options) {
 ...
 * @returns {*}
 */
function addListMember(mail_list_addr, member_addr, name, options) {
...
function updateListMember(mail_list_addr, member_addr, name, options) {
  var _data = getListMemberData(mail_list_addr, member_addr, name,options);
 ...
 * @param targetList
 */
function addToOtherList(souceList, targetList) {
